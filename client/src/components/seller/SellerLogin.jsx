...
//                 <p>Email</p>
//                 <input type="email" placeholder="enter your email" className="border border-gray-200 rounded w-full p-2 mt- outline-primary" required/>
//             </div>
...
//             </div>
//             <button className="bg-primary text-white w-full py-2 required-md cursor-pointer">Login</button>
//         </div>
//     </form>
// )
// }
